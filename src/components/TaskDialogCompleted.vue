                    ...
                    <div class="p-5 pl-3 pr-3 flex flex-col gap-6 max-h-[90vh] overflow-y-auto">
                        <div class="d-flex flex-column">
                            <div class="d-flex justify-space-between align-center">
                                <v-card-title class="text-truncate">{{ taskData.name }}</v-card-title>
                            ...
                            <div class="d-flex justify-space-between align-center mb-2">
                                <div class="p-5 pl-3">
                                    <strong>Создано:</strong> {{ formatTimestamp(taskData.created_at) }}
                                </div>
                                <div class="pr-14">
                                    <strong>Дедлайн:</strong> {{ formatTimestamp(taskData.deadline) }}
                                </div>
                            </div>
                            <!-- <div>

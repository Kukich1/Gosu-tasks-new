<template>
    <div>
        <v-row justify="center">
            <v-dialog v-model="this.$store.state.showEditProject" persistent width="1024">
                <v-card>
                    <v-card-title>
                        ...
                        <v-container>
                            <v-row>
                                ...
                                <v-col style="min-width: 350px;" cols="12" sm="6">
                                    <v-text-field :model-value="deadlineToISO($store.state.projectEdit.project.deadline)"
                                ...
                                <v-col cols="12" sm="6">
                                    <v-select :model-value="$store.state.projectEdit.project.members"
                                        ...
                                        :items="username" chips label="Выбрать пользователей" multiple></v-select>
                                </v-col>
                            </v-row>
                        </v-container>
